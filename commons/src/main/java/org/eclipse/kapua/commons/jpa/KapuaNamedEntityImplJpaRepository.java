...
public class KapuaNamedEntityImplJpaRepository<E extends KapuaNamedEntity>
        extends KapuaUpdatableEntityImplJpaRepository<E>
        implements KapuaNamedEntityRepository<E> {

    public KapuaNamedEntityImplJpaRepository(
    ...
    protected Long doCount(TxContext tx, String name, BiFunction<CriteriaBuilder, Root<E>, Predicate>... additionalPredicates) {
        ...
        // FROM
        final Root<E> entityRoot = criteriaSelectQuery.from(concreteClass);
        // SELECT
