...
public class KapuaEntityImplJpaRepository<E extends KapuaEntity> implements KapuaEntityRepository<E> {

    protected final Class<E> concreteClass;
     ...
     */
    public KapuaEntityImplJpaRepository(
    ...
    public KapuaListResult<E> query(TxContext txContext, KapuaQuery listQuery) throws KapuaException {
        ...
        CriteriaQuery<E> criteriaSelectQuery = cb.createQuery(concreteClass);
        // FROM
        Root<E> entityRoot = criteriaSelectQuery.from(concreteClass);
    ...
    protected Optional<E> doFindByField(@NonNull TxContext txContext,
        ...
        final List<E> result = doFindAllByField(txContext, scopeId, fieldName, fieldValue);
        switch (result.size()) {
        case 0:
    ...
    protected List<E> doFindAllByField(TxContext txContext, KapuaId scopeId, String fieldName, Object fieldValue) {
        final EntityManager em = JpaAwareTxContext.extractEntityManager(txContext);
    ...
    protected Predicate mapScopeIdToCriteria(KapuaId scopeId, CriteriaBuilder cb, Root<E> entityRoot) {
