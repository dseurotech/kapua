...
public class JobTriggers extends AbstractKapuaResource {
    ...
    public KapuaListResult<Trigger> simpleQuery(
    ...
    public KapuaListResult<Trigger> query(
            @PathParam("scopeId") ScopeId scopeId,
            @PathParam("jobId") EntityId jobId,
    ...
    public Trigger find(
        ...
        KapuaListResult<Trigger> triggerListResult = triggerService.query(triggerQuery);
