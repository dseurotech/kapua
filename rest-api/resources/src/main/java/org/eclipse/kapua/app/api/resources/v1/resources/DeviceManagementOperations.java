...
public class DeviceManagementOperations extends AbstractKapuaResource {
    ...
    public KapuaListResult<DeviceManagementOperation> simpleQuery(
    ...
    public KapuaListResult<DeviceManagementOperation> query(
            @PathParam("scopeId") ScopeId scopeId,
            @PathParam("deviceId") EntityId deviceId,
    ...
    public DeviceManagementOperation find(
        ...
        KapuaListResult<DeviceManagementOperation> results = deviceManagementOperationRegistryService.query(query);
