...
public class DeviceEvents extends AbstractKapuaResource {
    ...
    public KapuaListResult<DeviceEvent> simpleQuery(
    ...
    public KapuaListResult<DeviceEvent> query(
            @PathParam("scopeId") ScopeId scopeId,
            @PathParam("deviceId") EntityId deviceId,
    ...
    public DeviceEvent find(
        ...
        KapuaListResult<DeviceEvent> results = deviceEventService.query(query);
