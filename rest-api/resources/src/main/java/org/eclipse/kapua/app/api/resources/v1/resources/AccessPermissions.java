...
public class AccessPermissions extends AbstractKapuaResource {
    ...
    public KapuaListResult<AccessPermission> simpleQuery(
    ...
    public KapuaListResult<AccessPermission> query(
            @PathParam("scopeId") ScopeId scopeId,
            @PathParam("accessInfoId") EntityId accessInfoId,
    ...
    public AccessPermission find(
        ...
        KapuaListResult<AccessPermission> results = accessPermissionService.query(query);
