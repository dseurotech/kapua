...
public class RolesPermissions extends AbstractKapuaResource {
    ...
    public KapuaListResult<RolePermission> simpleQuery(
    ...
    public KapuaListResult<RolePermission> query(
            @PathParam("scopeId") ScopeId scopeId,
            @PathParam("roleId") EntityId roleId,
    ...
    public RolePermission find(
        ...
        KapuaListResult<RolePermission> results = rolePermissionService.query(query);
