...
public interface TagService extends KapuaEntityService<Tag, TagCreator>,
    ...
    /**
     * Creates a new {@link Tag} based on the parameters provided in the {@link TagCreator}.<br> {@link Tag} must have a unique name within the scope.
     *
     * @param tagCreator
    ...
    /**
     * Updates the {@link Tag} according the given updated entity.<br> The {@link Tag#getName()} can be updated, but must remain unique within the scope.
     *
     * @param tag
     ...
     */
    @Override
    KapuaListResult<Tag> query(KapuaQuery query) throws KapuaException;
