...
public class AccessPermissionServiceImpl implements AccessPermissionService {
    ...
    @Override
    public KapuaListResult<AccessPermission> findByAccessInfoId(KapuaId scopeId, KapuaId accessInfoId)
            throws KapuaException {
        ArgumentValidator.notNull(scopeId, KapuaEntityAttributes.SCOPE_ID);
    ...
    @Override
    public KapuaListResult<AccessPermission> query(KapuaQuery query)
            throws KapuaException {
