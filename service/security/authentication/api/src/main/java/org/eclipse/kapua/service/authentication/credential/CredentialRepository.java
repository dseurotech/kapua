...
public interface CredentialRepository
        extends KapuaUpdatableEntityRepository<Credential> {
     ...
     * @since 2.0.0
     */
    KapuaListResult<Credential> findByUserId(TxContext txContext, KapuaId scopeId, KapuaId userId) throws KapuaException;
}
