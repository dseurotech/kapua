...
public interface CredentialService extends KapuaEntityService<Credential, CredentialCreator>,
     ...
     * @since 1.0.0
     */
    KapuaListResult<Credential> findByUserId(KapuaId scopeId, KapuaId userId) throws KapuaException;
     ...
     * @since 1.0.0
     */
    KapuaListResult<Credential> findByUserId(KapuaId scopeId, KapuaId userId, String credentialType) throws KapuaException;
