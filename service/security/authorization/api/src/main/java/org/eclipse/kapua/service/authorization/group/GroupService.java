...
public interface GroupService extends KapuaEntityService<Group, GroupCreator>,
    ...
    /**
     * Creates a new {@link Group} based on the parameters provided in the {@link GroupCreator}.<br> {@link Group} must have a unique name within the scope.
     *
     * @param groupCreator
    ...
    /**
     * Updates the {@link Group} according the given updated entity.<br> The {@link Group#getName()} can be updated, but must remain unique within the scope.
     *
     * @param group
